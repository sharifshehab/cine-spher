                ...
                <div className="flex  flex-col lg:flex-row items-center justify-between gap-10">
                    <div className="border border-[#e5eaf2] shadow-lg">
                        <div className="w-full flex items-center justify-center flex-col p-6">
                            ...
                            <p className="text-[#424242] text-[1rem]">Ideal for growing movie enthusiasts</p>
                            ...
                            <button className="px-12 py-2 bg-textColor rounded text-white my-6">
                                Join Now
                            </button>
                        </div>
                    ...
                    <div className="border border-[#e5eaf2] shadow-lg">
                        <div className="w-full flex items-center justify-center flex-col p-6">
                            ...
                            <p className="text-[#424242] text-[1rem]">For movie lovers who want the best experience</p>
                    ...
                    <div className="border border-[#e5eaf2] shadow-lg">
                        <div className="w-full flex items-center justify-center flex-col p-6">
                            ...
                            <p className="text-[#424242] text-[1rem]">For the ultimate movie streaming experience</p>
